...
$system_title   = "FUNDACITE | INVENTARIO"; //titulo del sistema ::: TEC
...
$redir          = 'http://localhost/fundacite-inv/index.php';
$ruta_base      = '//localhost/fundacite-inv/';
// Configuracion de Modulos Activos en en Sistema (0:Inactivo, 1:Activo)
$mod_moodle  = 0;
//Mod Chat
global $absolute_uri;
$absolute_uri   = 'http://localhost/fundacite-inv/';
$mod_chat       = 1;
// Mensajes de error.
